...
import com.nd705.suppointspb.dao.BucketRepository;
import com.nd705.suppointspb.dao.ProductRepository;
import com.nd705.suppointspb.dto.BucketDTO;
import com.nd705.suppointspb.dto.BucketDetailDTO;
...
private final UserService userService;
    ...
    private List<Product> getCollectProductsByIds(List<Long> productsIds) {
        return productsIds.stream()
                //getOne - вытаскивает ссылку на объектб findById - вытаскивает сам объект
    ...
    public void addProducts(Bucket bucket, List<Long> productsIds) {
        ...
        newProductList.addAll(getCollectProductsByIds(productsIds));
